 ...
 * 
 */
@WebServiceClient(name = "HelloObjisWSService", targetNamespace = "http://simple.tp2.tlacomblez.com/", wsdlLocation = "http://localhost:8888/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOOBJISWSSERVICE_QNAME = new QName("http://simple.tp2.tlacomblez.com/", "HelloObjisWSService");
    ...
    public HelloObjis getHelloObjisWSPort() {
        return super.getPort(new QName("http://simple.tp2.tlacomblez.com/", "HelloObjisWSPort"), HelloObjis.class);
    }
    ...
    public HelloObjis getHelloObjisWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://simple.tp2.tlacomblez.com/", "HelloObjisWSPort"), HelloObjis.class, features);
    }
